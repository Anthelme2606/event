...
<div class="row min-vh-100">
    ...
    <div class="col-lg-6 d-flex align-items-center justify-content-center bg-custom-dark p-5">
        <div class="w-100" style="max-width: 400px;">
            ...
            <form action="<?php echo e(route('log_in')); ?>" method="POST">
...
<?php echo $__env->make('layouts.setup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\event_management\event\resources\views\authentification\login.blade.php ENDPATH**/ ?>