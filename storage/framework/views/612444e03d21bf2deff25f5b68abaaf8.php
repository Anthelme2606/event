...
<section class="hero-section text-center text-light"
 style="background-image: url('<?php echo e(asset('assets/images/hero.jpeg')); ?>');
  ...
  <?php /**PATH C:\projects\event_management\event\resources\views/layouts/hero.blade.php ENDPATH**/ ?>