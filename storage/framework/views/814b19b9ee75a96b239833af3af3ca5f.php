<section class="about-section py-5">
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <img src="<?php echo e(asset('assets/images/event.png')); ?>" alt="About Image" class="img-fluid">
        </div>
        <div class="col-md-6">
  ...
  <?php /**PATH C:\projects\event_management\event\resources\views/layouts/about.blade.php ENDPATH**/ ?>